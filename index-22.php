        ...
        <main class="main">
            ...
            <div class="container banner-container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 banner-lg">
                        <a href="category.html">
                            <img src="assets/images/demos/demo-22/banner/banner-1.jpg" alt="Banner 1">
                        </a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 banner-lg">
                        <a href="category.html">
                            <img src="assets/images/demos/demo-22/banner/banner-2.jpg" alt="Banner 2">
                        </a>
                        <div class="banner-content">
                            <div class="title">
                ...
                <div class="row products">
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <span class="product-label label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="assets/images/demos/demo-22/products/product-1.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <span class="product-label label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="assets/images/demos/demo-22/products/product-2.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="assets/images/demos/demo-22/products/product-3.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="assets/images/demos/demo-22/products/product-4.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="assets/images/demos/demo-22/products/product-5.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="assets/images/demos/demo-22/products/product-6.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <span class="product-label label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="assets/images/demos/demo-22/products/product-7.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="assets/images/demos/demo-22/products/product-8.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="assets/images/demos/demo-22/products/product-9.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                        <div class="product product-3 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="assets/images/demos/demo-22/products/product-10.jpg" alt="Product image" class="product-image">
                                </a>
            ...
            <div class="container bannerad">
                <div class="banner-lg"  style="background-image: url(assets/images/demos/demo-22/bannerad/background.jpg);">
                    <div class="price">
                        <h4 class="highlight">from</h4><h3>$39</h3><sup class="highlight">,99</sup>
                    </div>
                    <div class="content">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-3">
                            <div class="widget widget-about">
                                <img src="assets/images/demos/demo-22/logo-footer.png" class="footer-logo" alt="Footer Logo" width="100" height="25">
