    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <section class="instagram mb-3">
                <div class="container">
                    <div class="heading">
                        <h5 class="heading-cat">Follow Us On Instagram <span class="highlight">@molla_store</span></h5>
                    </div>
                    <div class="row">
                        <div class="col-xl-5col col-md-3 col-6 instagram-feed">
                            <img src="assets/images/demos/demo-24/instagram/back-1.jpg" alt="Instagram 1">
                        ...
                        <div class="col-xl-5col col-md-3 col-6 instagram-feed">
                            <img src="assets/images/demos/demo-24/instagram/back-2.jpg" alt="Instagram 2">
                            <div class="instagram-feed-content">
                                <a href="#"><i class="icon-heart-o"></i>280</a>
                                <a href="#"><i class="icon-comments"></i>22</a>
                            </div>
                        ...
                        <div class="col-xl-5col col-md-3 col-6 instagram-feed">
                            <img src="assets/images/demos/demo-24/instagram/back-3.jpg" alt="Instagram 3">
                            <div class="instagram-feed-content">
                                <a href="#"><i class="icon-heart-o"></i>280</a>
                                <a href="#"><i class="icon-comments"></i>22</a>
                            </div>
                        ...
                        <div class="col-xl-5col col-md-3 col-6 instagram-feed">
                            <img src="assets/images/demos/demo-24/instagram/back-4.jpg" alt="Instagram 4">
                            <div class="instagram-feed-content">
                                <a href="#"><i class="icon-heart-o"></i>280</a>
                                <a href="#"><i class="icon-comments"></i>22</a>
                            </div>
                        ...
                        <div class="col-xl-5col col-md-3 col-6 instagram-feed">
                            <img src="assets/images/demos/demo-24/instagram/back-5.jpg" alt="Instagram 5">
                            <div class="instagram-feed-content">
                                <a href="#"><i class="icon-heart-o"></i>280</a>
                                <a href="#"><i class="icon-comments"></i>22</a>
                            </div>
