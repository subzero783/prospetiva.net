					...
					<div class="header-main">
						<nav class="main-nav">
                            <ul class="menu sf-arrows">
                                    ...
                                    <div class="megamenu demo left">
                                        <div class="menu-col">
                                            ...
                                            <div class="megamenu-action text-left">
                                                <a href="#" class="btn view-all-demos"><span>View All Demos</span><i class="icon-long-arrow-right"></i></a>
                                            </div><!-- End .text-center -->
                                        </div><!-- End .menu-col -->
                                    </div><!-- End .megamenu -->
                                </li>
                                ...
                                <li>
                                    <a href="about.html" class="sf-with-ul">About us </a>
                                    <div class="megamenu demo left">
                                        <div class="menu-col">
                                            <div class="menu-title">About us</div><!-- End .menu-title -->
                                            <ul>
                                ...
                                <li>
                                    <a href="contact.html" class="sf-with-ul">contacts</a>
                                    <div class="megamenu demo left">
                                        <div class="menu-col">
                                            <div class="menu-title">contacts</div><!-- End .menu-title -->
                                            <ul>
                                ...
                                <li>
                                    <a href="#" class="sf-with-ul">buy Molla</a>

                                    <div class="megamenu demo left">
                                    	<div class="menu-col">
                                    		<div class="menu-title">Molla elements</div>
                                    		<ul>
			...
			<div class="page-content-div">
				<main class="main">
		            ...
		            <section class="new-women row">
		            	<div class="banner col-lg-6 col-md-5 col-sm-6 col-12">
		            		<div class="banner-lg">
		            			<img src="assets/images/demos/demo-23/new-women/banner.jpg" alt="New Women Banner">
		            			<div class="intro">
		            				<div class="title">
		            					<h3>New arrivals</h3>
		            				</div>
		            ...
		            <section class="new-men row mt-12">
			            		...
			            		<div class="product product-9 text-center">
	                                ...
	                                <div class="product-body">
		                                ...
		                                <div class="product-detail">
		                                    ...
		                                    <div class="product-nav product-nav-dots">
		                                        <a href="#" class="active">
		                                        	<img src="assets/images/demos/demo-23/new-men/product-color-3-1.jpg" alt="Product 3-1">
		                                        </a>
		                                        <a href="#">
		                                        	<img src="assets/images/demos/demo-23/new-men/product-color-3-2.jpg" alt="Product 3-2">
		                                        </a>
		                                    </div><!-- End .product-nav -->
		                                </div>
	                                </div><!-- End .product-body -->
		            	...
		            	<div class="banner col-lg-6 col-md-5 col-sm-6 col-12">
		            		<div class="banner-lg">
		            			<img src="assets/images/demos/demo-23/new-men/banner.jpg" alt="New Men Banner">
		            			<div class="intro">
		            				<div class="title">
		            					<h3>New arrivals</h3>
		            				</div>
		            ...
		            <section class="banner-section">
		            	<div class="banner-lg">
		            		<img src="assets/images/demos/demo-23/banners/banner-1.jpg" alt="Banner 1">
		            		<div class="intro">
		            			<div class="title">
		            	...
		            	<div class="col-lg-6 col-md-6 col-12">
		            		<div class="banner-sm">
		            			<img src="assets/images/demos/demo-23/banners/banner-2.jpg" alt="Banner 2">
			            		<div class="intro">
			            			<div class="title">
		            	...
		            	<div class="col-lg-6 col-md-6 col-12">
		            		<div class="banner-sm">
		            			<img src="assets/images/demos/demo-23/banners/banner-3.jpg" alt="Banner 3">
		            			<div class="intro">
			            			<div class="title">
                            ...
                            <div class="product product-9 text-center">
                                ...
                                <div class="product-body">
                                	...
                                	<div class="product-detail">
	                                    ...
	                                    <div class="product-nav product-nav-dots">
	                                        <a href="#" class="active">
	                                        	<img src="assets/images/demos/demo-23/tranding/product-color-3-1.jpg" alt="Tranding Product 3-1">
	                                        </a>
	                                        <a href="#">
	                                        	<img src="assets/images/demos/demo-23/tranding/product-color-3-2.jpg" alt="Tranding Product 3-2">
	                                        </a>
	                                    </div><!-- End .product-nav -->
                                	</div>
                                </div><!-- End .product-body -->
		            ...
		            <section class="instagram">
		            	...
		            	<div class="instagram-images">
		            		<div class="col-xl-5col col-md-3 col-sm-4 col-6 instagram-feed">
		            			<img src="assets/images/demos/demo-23/instagram/img-1.jpg" alt="Instagram 1">
		            		...
		            		<div class="col-xl-5col col-md-3 col-sm-4 col-6 instagram-feed">
		            			<img src="assets/images/demos/demo-23/instagram/img-2.jpg" alt="Instagram 2">
                                <div class="instagram-feed-content">
                                    <a href="#"><i class="icon-heart-o"></i>280</a>
                                    <a href="#"><i class="icon-comments"></i>22</a>
                                </div>
		            		...
		            		<div class="col-xl-5col col-md-3 col-sm-4 col-6 instagram-feed">
		            			<img src="assets/images/demos/demo-23/instagram/img-3.jpg" alt="Instagram 3">
                                <div class="instagram-feed-content">
                                    <a href="#"><i class="icon-heart-o"></i>280</a>
                                    <a href="#"><i class="icon-comments"></i>22</a>
                                </div>
		            		...
		            		<div class="col-xl-5col col-md-3 col-sm-4 col-6 instagram-feed">
		            			<img src="assets/images/demos/demo-23/instagram/img-4.jpg" alt="Instagram 4">
                                <div class="instagram-feed-content">
                                    <a href="#"><i class="icon-heart-o"></i>280</a>
                                    <a href="#"><i class="icon-comments"></i>22</a>
                                </div>
		            		...
		            		<div class="col-xl-5col col-md-3 col-sm-4 col-6 instagram-feed">
		            			<img src="assets/images/demos/demo-23/instagram/img-5.jpg" alt="Instagram 5">
                                <div class="instagram-feed-content">
                                    <a href="#"><i class="icon-heart-o"></i>280</a>
                                    <a href="#"><i class="icon-comments"></i>22</a>
                                </div>
				...
				<footer class="footer">
					...
					<section class="footer-bottom">
	                    ...
	                    <div class="col-xl-8-2col col-sm-4 col-md-4">
	                        <div class="widget">
	                    ...
	                    <div class="col-xl-8-1col col-sm-4 col-md-4">
	                        <div class="widget">
