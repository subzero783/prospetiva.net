        ...
        <main class="main">
            <div class="intro-slider-container">
                <div class="intro-slider owl-carousel owl-simple owl-nav-inside owl-light" data-toggle="owl" data-owl-options='{"nav":false, "dots": false, "loop": false}'>
                    <div class="intro-slide" style="background-image: url(assets/images/demos/demo-16/slider/slide-1.jpg);">
            ...
            <div class="container" id="scroll-to-content">
                ...
                <div class="products-display">
                    <div class="heading text-center">
                        <h4 class="subtitle text-primary">Womens Clothing</h4><!-- End .subtitle -->
                        <h2 class="title">Refresh Your Wardrobe</h2><!-- End .title -->
                        <p class="title-desc">Discover this season’s latest trends with the newest additions to <br>our women’s clothing collection.</p><!-- End .title-desc -->
                    </div><!-- End .heading -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="banner banner-main banner-overlay">
                                <a href="category.html">
                                    <img src="assets/images/demos/demo-16/banners/banner-1.jpg" alt="Banner">
                                </a>
                            ...
                            <div class="display-products-col">
                                <div class="product product-4 mb-7">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="assets/images/demos/demo-16/products/product-1.jpg" alt="Product image" class="product-image">
                                            <img src="assets/images/demos/demo-16/products/product-1-2.jpg" alt="Product image" class="product-image-hover">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        <h3 class="product-title"><a href="product.html">Black ruched side slip dress</a></h3><!-- End .product-title -->
                                ...
                                <div class="row">
                                    <div class="col-6 col-lg-12">
                                        <div class="product product-4 mb-7">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="assets/images/demos/demo-16/products/product-2.jpg" alt="Product image" class="product-image">
                                                    <img src="assets/images/demos/demo-16/products/product-2-2.jpg" alt="Product image" class="product-image-hover">
                                                </a>
                                            ...
                                            <div class="product-body">
                                                <h3 class="product-title"><a href="product.html">Dark brown belted shirt dress</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $100.00
                                                </div><!-- End .product-price -->
                                            </div><!-- End .product-body -->
                                    ...
                                    <div class="col-6 col-lg-12">
                                        <div class="product product-4 mb-7">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="assets/images/demos/demo-16/products/product-3.jpg" alt="Product image" class="product-image">
                                                    <img src="assets/images/demos/demo-16/products/product-3-2.jpg" alt="Product image" class="product-image-hover">
                                                </a>
                                            ...
                                            <div class="product-body">
                                                <h3 class="product-title"><a href="product.html">Blue belted midi denim dress</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $110.00
                                                </div><!-- End .product-price -->
                                            </div><!-- End .product-body -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="banner banner-main banner-main-reverse banner-overlay">
                                <a href="category.html">
                                    <img src="assets/images/demos/demo-16/banners/banner-2.jpg" alt="Banner">
                                </a>
                                ...
                                <div class="row">
                                    <div class="col-6 col-lg-12">
                                        <div class="product product-4">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="assets/images/demos/demo-16/products/product-4.jpg" alt="Product image" class="product-image">
                                                    <img src="assets/images/demos/demo-16/products/product-4-2.jpg" alt="Product image" class="product-image-hover">
                                                </a>
                                            ...
                                            <div class="product-body">
                                                <h3 class="product-title"><a href="product.html">Dark yellow cropped denim jacket</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $96.00
                                                </div><!-- End .product-price -->
                                            </div><!-- End .product-body -->
                                    ...
                                    <div class="col-6 col-lg-12">
                                        <div class="product product-4">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="assets/images/demos/demo-16/products/product-5.jpg" alt="Product image" class="product-image">
                                                    <img src="assets/images/demos/demo-16/products/product-5-2.jpg" alt="Product image" class="product-image-hover">
                                                </a>
                                            ...
                                            <div class="product-body">
                                                <h3 class="product-title"><a href="product.html">Light brown faux suede biker jacket</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $358.00
                                                </div><!-- End .product-price -->
                                            </div><!-- End .product-body -->
                        ...
                        <div class="col-sm-4 col-lg-3">
                            <div class="display-products-col">
                                <div class="product product-4">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="assets/images/demos/demo-16/products/product-6.jpg" alt="Product image" class="product-image">
                                            <img src="assets/images/demos/demo-16/products/product-6-2.jpg" alt="Product image" class="product-image-hover">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        <h3 class="product-title"><a href="product.html">Light brown check suedette <br>trench coat</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $170.00
                                        </div><!-- End .product-price -->
                                    </div><!-- End .product-body -->
            ...
            <div class="bg-lighter pt-6 pb-9">
                <div class="container">
                    <div class="heading text-center">
                        <h2 class="title">Shop The Collection</h2><!-- End .title -->
                        <p class="title-desc">Donec nec justo eget felis facilisis fermentum. <br>Aliquam porttitor mauris sit amet orci..</p><!-- End .title-desc -->
                    </div><!-- End .heading -->
                    ...
                    <div class="owl-carousel owl-simple" data-toggle="owl" 
                        ...
                        <div class="product product-4">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="assets/images/demos/demo-16/products/product-7.jpg" alt="Product image" class="product-image">
                                    <img src="assets/images/demos/demo-16/products/product-7-2.jpg" alt="Product image" class="product-image-hover">
                                </a>
                        ...
                        <div class="product product-4">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="assets/images/demos/demo-16/products/product-8.jpg" alt="Product image" class="product-image">
                                    <img src="assets/images/demos/demo-16/products/product-8-2.jpg" alt="Product image" class="product-image-hover">
                                </a>
                        ...
                        <div class="product product-4">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="assets/images/demos/demo-16/products/product-9.jpg" alt="Product image" class="product-image">
                                    <img src="assets/images/demos/demo-16/products/product-9-2.jpg" alt="Product image" class="product-image-hover">
                                </a>
                        ...
                        <div class="product product-4">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="assets/images/demos/demo-16/products/product-10.jpg" alt="Product image" class="product-image">
                                    <img src="assets/images/demos/demo-16/products/product-10-2.jpg" alt="Product image" class="product-image-hover">
                                </a>
                        ...
                        <div class="product product-4">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product.html">Gray-blend dress</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $85.00
                                </div><!-- End .product-price -->
                            </div><!-- End .product-body -->
            ...
            <div class="video-banner video-banner-bg bg-image text-center" style="background-image: url(assets/images/demos/demo-16/bg-1.jpg)">
                <div class="container">
            ...
            <div class="blog-posts">
                <div class="container">
                    ...
                    <div class="owl-carousel owl-simple mb-4" data-toggle="owl" 
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="assets/images/demos/demo-16/blog/post-1.jpg" alt="image desc">
                                </a>
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="assets/images/demos/demo-16/blog/post-2.jpg" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="assets/images/demos/demo-16/blog/post-3.jpg" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                    ...
                    <div class="more-container text-center">
                        <a href="blog.html" class="btn btn-outline-primary-2 btn-more"><span>View more articles</span><i class="icon-long-arrow-right"></i></a>
            ...
            <div class="cta-newsletter text-center pt-4 pb-7">
                <div class="container">
                    ...
                    <p class="title-desc">and receive <span class="text-primary">$20 coupon</span> for first shopping</p><!-- End .title-desc -->
            ...
            <div class="bg-lighter instagram pb-5">
                <div class="container">
                    <h2 class="title text-center mb-3 mb-md-4">Let Us Inspire You On Instagram</h2><!-- End .title -->
                    ...
                    <div class="owl-carousel owl-simple" data-toggle="owl" 
                        ...
                        <div class="instagram-feed">
                            <img src="assets/images/demos/demo-16/instagram/1.jpg" alt="img">
                        ...
                        <div class="instagram-feed">
                            <img src="assets/images/demos/demo-16/instagram/2.jpg" alt="img">
                        ...
                        <div class="instagram-feed">
                            <img src="assets/images/demos/demo-16/instagram/3.jpg" alt="img">
                        ...
                        <div class="instagram-feed">
                            <img src="assets/images/demos/demo-16/instagram/4.jpg" alt="img">
                        ...
                        <div class="instagram-feed">
                            <img src="assets/images/demos/demo-16/instagram/5.jpg" alt="img">
