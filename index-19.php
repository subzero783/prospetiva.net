                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-xl-6">
                            <div class="banner banner-overlay banner-lg  content-left">
                                ...
                                <div class="banner-content">
                                    ...
                                    <h3 class="banner-title">Borderlands 3</h3>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            ...
                            <div class="banner banner-overlay d-none d-lg-block banner-sm content-right align-center">
                                ...
                                <div class="banner-content text-right">
                                    <img class="banner-title-img" src="assets/images/demos/demo-19/banners/banner-3-title.png" alt="Banner-3" style="margin-bottom: 1.3rem; margin-top: -.8rem;">
                                    <a href="#" class="banner-link">Buy Now<i class="icon-long-arrow-right"></i></a>
                                </div> 
                            </div><!-- End .banner -->
                        </div><!-- End .col-lg-3 -->
                        ...
                        <div class="col-lg-9">
                            <div class="banner banner-overlay banner-lg  content-right">
                                ...
                                <div class="banner-content text-right">
                                    ...
                                    <img class="banner-title-img" src="assets/images/demos/demo-19/banners/banner-5-title.png" alt="Banner-5">
                                    <a href="#" class="banner-link">Pre-Order Now<i class="icon-long-arrow-right"></i></a>
                                </div>
                            </div><!-- End .banner -->
                        </div><!-- End .col-lg-9 -->
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="banner banner-overlay banner-sm banner-ad content-left align-center">
                                ...
                                <div class="banner-content">
                                    ...
                                    <img class="banner-title-img" src="assets/images/demos/demo-19/banners/banner-7-title.png" alt="Banner-7">
                                ...
                                <div class="games-banners-slider owl-carousel owl-simple" data-toggle="owl" 
                                    ...
                                    <div class="banner banner-overlay product-banner">
                                        ...
                                        <div class="banner-content align-items-center center">
                                            <h4 class="banner-subtitle text-white">Out 14 May 2019</h4>
                                            <img class="banner-title-img" src="assets/images/demos/demo-19/banners/banner-9-title.png" alt="Banner-9">
                                            <h4 class="banner-price">$29.99</h4>
                                            <a href="#" class="banner-link">Pre-Order Now<i class="icon-long-arrow-right"></i></a>
                                        </div>
                                    </div><!-- End .banner -->
                                    ...
                                    <div class="banner banner-overlay product-banner">
                                        ...
                                        <div class="banner-content">
                                            <h4 class="banner-subtitle text-white">Out 14 May 2019</h4>
                                            <img class="banner-title-img" src="assets/images/demos/demo-19/banners/banner-10-title.png" alt="Banner-10">
                                            <h4 class="banner-price">$79.99</h4>
                                            <a href="#" class="banner-link">Pre-Order Now<i class="icon-long-arrow-right"></i></a>
                                        </div>
                                    </div><!-- End .banner -->
                                    ...
                                    <div class="banner banner-overlay product-banner">
                                        <a href="#">
                                            <img src="assets/images/demos/demo-19/banners/banner-11.jpg" alt="Banner">
                                        </a>
                                        <div class="banner-content align-items-center center">
                                            <h4 class="banner-subtitle text-white">Out 14 May 2019</h4>
                                            <img class="banner-title-img" src="assets/images/demos/demo-19/banners/banner-11-title.png" alt="Banner-11">
                                            <h4 class="banner-txt">Main Game & Kombat Pack</h4>
                                            <img class="banner-title-img" src="assets/images/demos/demo-19/banners/banner-11-subtitle.png" alt="Banner-11">
                                            <h4 class="banner-price mt-1">$99.99</h4>
                                            <a href="#" class="banner-link">Pre-Order Now<i class="icon-long-arrow-right"></i></a>
                                        </div>
                                    </div><!-- End .banner -->
                                </div><!-- End .owl-carousel -->
