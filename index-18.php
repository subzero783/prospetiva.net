                                        ...
                                        <div class="products">
                                            <div class="product product-sm">
                                                ...
                                                <div class="product-body">
                                                    ...
                                                    <h5 class="product-title"><a href="product.html">V-neck buttoned blouse</a></h5><!-- End .product-title -->
                                                    <div class="product-price">
                                            ...
                                            <div class="product product-sm">
                                                ...
                                                <div class="product-body">
                                                    ...
                                                    <h5 class="product-title"><a href="product.html">Slides with a bow</a></h5><!-- End .product-title -->
                                                    <div class="product-price">
                                                        $17.99
                                                    </div><!-- End .product-price -->
                                                </div><!-- End .product-body -->
                                            ...
                                            <div class="product product-sm">
                                                ...
                                                <div class="product-body">
                                                    ...
                                                    <h5 class="product-title"><a href="product.html">Paper bag skirt</a></h5><!-- End .product-title -->
                                                    <div class="product-price">
                                                        $19.99
                                                    </div><!-- End .product-price -->
                                                </div><!-- End .product-body -->
                                            ...
                                            <div class="product product-sm">
                                                ...
                                                <div class="product-body">
                                                    ...
                                                    <h5 class="product-title"><a href="product.html">Foldaway waist bag</a></h5><!-- End .product-title -->
                                                    <div class="product-price">
                                                        $9.99
                                                    </div><!-- End .product-price -->
                                                </div><!-- End .product-body -->
                                            ...
                                            <article class="entry">
                                                ...
                                                <div class="entry-body">
                                                    ...
                                                    <div class="entry-content">
                                                        <p>Lorem ipsum dolor sit amet, consec tetuer adipiscing elit. Donec odio</p>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-3">
                            <div class="widget widget-about">
                                <img src="assets/images/demos/demo-18/logo-footer.png" class="footer-logo" alt="Footer Logo" width="82" height="25">
