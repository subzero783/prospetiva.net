        ...
        <main class="main">
            ...
            <div class="container banner-container">
                <div class="col-lg-4 col-md-8 col-sm-10 col-12 col-pd1">
                    <a href="category.html">
                        <img src="assets/images/demos/demo-21/banner/banner-1.jpg" alt="Banner 1">
                    </a>
                ...
                <div class="col-lg-4 col-md-8 col-sm-10 col-12 col-pd1">
                    <a href="category.html">
                        <img src="assets/images/demos/demo-21/banner/banner-2.jpg" alt="Banner 2">
                    </a>
                    <div class="banner-content">
                        <div class="title">
                ...
                <div class="col-lg-4 col-md-8 col-sm-10 col-12 col-pd1">
                    <a href="category.html">
                        <img src="assets/images/demos/demo-21/banner/banner-3.jpg" alt="Banner 3">
                    </a>
                    <div class="banner-content">
                        <div class="title">
                            ...
                            <div class="col-lg-4 col-md-4 col-6">
                                <div class="product demo21">
                                    ...
                                    <div class="product-body text-center">
                                        ...
                                        <h3 class="product-title"><a href="product.html">Stowell Hood Fleece</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                            ...
                            <div class="col-lg-4 col-md-4 col-6">
                                <div class="product demo21">
                                    ...
                                    <div class="product-body text-center">
                                        ...
                                        <h3 class="product-title"><a href="product.html">Force Tight</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                            ...
                            <div class="col-lg-4 col-md-4 col-6">
                                <div class="product demo21">
                                    ...
                                    <div class="product-body text-center">
                                        ...
                                        <h3 class="product-title"><a href="product.html">Blitzing 3.0 Cap</a></h3><!-- End .product-title -->
                                        <div class="product-price">
            ...
            <div class="container category-banner">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <a href="category.html">
                            <img src="assets/images/demos/demo-21/banner/footware.jpg" alt="Footware Banner">
                        </a>
                        <div class="banner-content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <a href="category.html">
                            <img src="assets/images/demos/demo-21/banner/accessories.jpg" alt="">
                        </a>
                        <div class="banner-content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6" >
                        <a href="category.html">
                            <img src="assets/images/demos/demo-21/banner/mens.jpg" alt="Men Banner">
                        </a>
                        <div class="banner-content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <a href="category.html">
                            <img src="assets/images/demos/demo-21/banner/womens.jpg" alt="Women Banner">
                        </a>
                        <div class="banner-content">
                ...
                <div class="row">
                    <div class="col-sm-3 banner-sm-div">
                        <div class="banner-sm col-12 instagram-feed">
                            <img src="assets/images/demos/demo-21/instagramStore/banner-1.jpg" alt="Instagram 1">
                        ...
                        <div class="banner-sm col-12 instagram-feed">
                            <img src="assets/images/demos/demo-21/instagramStore/banner-2.jpg" alt="Instagram 2">
                            <div class="instagram-feed-content">
                                <a href="#"><i class="icon-heart-o"></i>280</a>
                                <a href="#"><i class="icon-comments"></i>22</a>
                            </div>
                    ...
                    <div class="col-sm-3 banner-lg instagram-feed">
                        <img src="assets/images/demos/demo-21/instagramStore/banner-3.jpg" alt="Instagram 3">
                        <div class="instagram-feed-content">
                            <a href="#"><i class="icon-heart-o"></i>280</a>
                            <a href="#"><i class="icon-comments"></i>22</a>
                        </div>
                    ...
                    <div class="col-sm-3 banner-sm-div">
                        <div class="banner-sm col-6 instagram-feed">
                            <img src="assets/images/demos/demo-21/instagramStore/banner-4.jpg" alt="Instagram 4">
                            <div class="instagram-feed-content">
                                <a href="#"><i class="icon-heart-o"></i>280</a>
                                <a href="#"><i class="icon-comments"></i>22</a>
                            </div>
                        ...
                        <div class="banner-sm col-6 instagram-feed">
                            <img src="assets/images/demos/demo-21/instagramStore/banner-6.jpg" alt="Instagram 6">
                            <div class="instagram-feed-content">
                                <a href="#"><i class="icon-heart-o"></i>280</a>
                                <a href="#"><i class="icon-comments"></i>22</a>
                            </div>
                    ...
                    <div class="col-sm-3 banner-sm-div">
                        <div class="banner-sm col-6 instagram-feed">
                            <img src="assets/images/demos/demo-21/instagramStore/banner-5.jpg" alt="Instagram 5">
                            <div class="instagram-feed-content">
                                <a href="#"><i class="icon-heart-o"></i>280</a>
                                <a href="#"><i class="icon-comments"></i>22</a>
                            </div>
                        ...
                        <div class="banner-sm col-6 instagram-feed">
                            <img src="assets/images/demos/demo-21/instagramStore/banner-7.jpg" alt="Instagram 7">
                            <div class="instagram-feed-content">
                                <a href="#"><i class="icon-heart-o"></i>280</a>
                                <a href="#"><i class="icon-comments"></i>22</a>
                            </div>
                ...
                <div class="row">
                    <div class="col-2xl-5col col-md-12">
                        <div class="widget widget-about">
                            <img src="assets/images/demos/demo-21/logo-footer.png" class="footer-logo" alt="Footer Logo" width="100" height="25">
